...
python3 main.py --experiment tayside_cv --task train_cv --dataset tayside --dataset_dir ../../Datastes/Dermatology/Tayside --load_model tayside_cv;
...
python3 main.py --experiment isic_tayside --task tune_cv --dataset tayside --dataset_dir ../../Datastes/Dermatology/Tayside --load_model isic;

# Tune ISIC Using Tayside Cross Validation
python3 main.py --experiment isic_forth_valley --task tune_cv --dataset forth_valley --dataset_dir ../../Datastes/Dermatology/Forth_Valley_Macro --load_model isic;
...
python3 main.py --experiment sd260_tayside --task tune_cv --dataset tayside --dataset_dir ../../Datastes/Dermatology/Tayside --load_model sd260;

# Tune SD260 Using Tayside Cross Validation
python3 main.py --experiment sd260_forth_valley --task tune_cv --dataset forth_valley --dataset_dir ../../Datastes/Dermatology/Forth_Valley_Macro --load_model sd260;
...
# Tayside Cross Validation
python3 main.py --experiment tayside_cv_swin --task train_cv --dataset tayside --dataset_dir ../../Datastes/Dermatology/Tayside --load_model tayside_cv_swin --swin_model True;
...
# Tune ISIC Using Tayside Cross Validation
python3 main.py --experiment isic_tayside_swin --task tune_cv --dataset tayside --dataset_dir ../../Datastes/Dermatology/Tayside --load_model isic_swin --swin_model True;

# Tune ISIC Using Tayside Cross Validation
python3 main.py --experiment isic_forth_valley_swin --task tune_cv --dataset forth_valley --dataset_dir ../../Datastes/Dermatology/Forth_Valley_Macro --load_model isic_swin --swin_model True;
...
# Tune SD260 Using Tayside Cross Validation
python3 main.py --experiment sd260_tayside_swin --task tune_cv --dataset tayside --dataset_dir ../../Datastes/Dermatology/Tayside --load_model sd260_swin --swin_model True;

# Tune SD260 Using Tayside Cross Validation
python3 main.py --experiment sd260_forth_valley_swin --task tune_cv --dataset forth_valley --dataset_dir ../../Datastes/Dermatology/Forth_Valley_Macro --load_model sd260_swin --swin_model True;