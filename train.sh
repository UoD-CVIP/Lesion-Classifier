...
# Tune ISIC+SD260 Using Tayside Cross Validation
...
#Tune ISIC+SD260 Using Forth Valley Cross Validation
...
# Tune ISIC+SD260 Using Tayside Cross Validation
python3 main.py --experiment isic_sd260_tayside_swin --task tune_cv --dataset tayside --dataset_dir ../../Datasets/Dermatology/Tayside --load_model sd260_isic_swin --swin_model True --additional_dataset forth-valley --additional_dataset_dir ../../Datasets/Dermatology/Forth_Valley_Macro;

#Tune ISIC+SD260 Using Forth Valley Cross Validation
python3 main.py --experiment isic_sd260_forth_valley_swin --task tune_cv --dataset forth-valley --dataset_dir ../../Datasets/Dermatology/Forth_Valley_Macro --load_model sd260_isic_swin --swin_model True --additional_dataset tayside --additional_dataset_dir ../../Datasets/Dermatology/Tayside;
